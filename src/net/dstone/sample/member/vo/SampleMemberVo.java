...
package net.dstone.sample.member.vo;  
                      
import javax.xml.bind.annotation.XmlRootElement;

@XmlRootElement( name="SampleMemberVo" ) 
public class SampleMemberVo extends net.dstone.common.biz.BaseVo implements java.io.Serializable { 
