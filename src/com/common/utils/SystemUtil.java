...
public class SystemUtil {
	...
	*/
	public static void showMemoryInfo() {
		...
		System.out.println("Total amount of memory 	 [ " + com.common.utils.StringUtil.filler(String.valueOf(nf.format(totalMem)), 20, " ") + " byte]");
		System.out.println("Amount of free memory 	 [ " + com.common.utils.StringUtil.filler(String.valueOf(nf.format(freeMem)), 20, " ") + " byte]");
	...
	*/
	public static String getMemoryInfo(String div) {
		...
		buff.append("Total amount of memory 	 [ " + com.common.utils.StringUtil.filler(String.valueOf(nf.format(totalMem)), 20, " ") + " byte]").append(div);
		buff.append("Amount of free memory 	 [ " + com.common.utils.StringUtil.filler(String.valueOf(nf.format(freeMem)), 20, " ") + " byte]").append(div);
