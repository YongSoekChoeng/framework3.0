...
public class BizGenerator {
	...
	public static String COMM_CUD_PACKAGE_NAME = "com.common.biz.cud";
	...
	protected static String[] getPrimarykeys(String TABLE_NAME) {
		com.common.utils.DbUtil db = null;
		com.common.utils.DataSet ds = null;
		String[] primarykeys = new String[0];
		StringBuffer keySql = new StringBuffer();

		try {
			db = new com.common.utils.DbUtil(DBID);
			...
			if ("ORACLE".equals(db.currentDbKind)) {
				...
				ds = new com.common.utils.DataSet(db.select());
				...
				db.getConnection();
				String DB_URL = com.common.utils.SystemUtil.getInstance().getProperty(DBID + ".strUrl");
				String DB_SID = "MYDB";
				if(DB_URL.indexOf("/") != -1){
	 ...
	 * @param fileGenYn (소스를 파일로 생성할지 여부.) 예) com.common.tools.BizGenerator.genVoForCud("TB_EVT_INFO", "이벤트정보", false);
	 */
	public static void genVoForCud(String TABLE_NAME, String TABLE_HAN_NAME, boolean fileGenYn) {
		(new com.common.tools.BizGenerator()).new VoGen().genVoByTable(TABLE_NAME, TABLE_HAN_NAME, com.common.tools.BizGenerator.COMM_CUD_PACKAGE_NAME + ".vo", "", fileGenYn);
	}
	 ...
	 * @param fileGenYn (소스를 파일로 생성할지 여부.) 예) com.common.tools.BizGenerator.genVoByTable("TB_EVT_INFO", "이벤트정보", "com.test.common.biz.vo", "TbEvtInfoVo", false);
	 */
	public static void genVoByTable(String TABLE_NAME, String TABLE_HAN_NAME, String strVoPackageName, String strVoName, boolean fileGenYn) {
		(new com.common.tools.BizGenerator()).new VoGen().genVoByTable(TABLE_NAME, TABLE_HAN_NAME, strVoPackageName, strVoName, fileGenYn);
	}

	/**
	 * <개요> SQL로 VO 생성하는 메소드. com.common.tools.BizGenerator.SQL_LOCATION에 정의된 SQL을 기반으로 VO를 생성한다.
	 * 
	 * @param strVoPackageName (VO패키지명. 필수.)
	 * @param strVoName (VO명. 필수)
	 * @param pageYn (페이징용 카운트 멤버를 생성할지 여부. 페이징이 들어가는 화면에 사용되는 VO라면 true로 세팅.)
	 * @param fileGenYn (소스를 파일로 생성할지 여부.) 예) com.common.tools.BizGenerator.genVoBySql("com.test.biz.event.vo", "EventListVo", true, false);
	 */
	public static void genVoBySql(String strVoPackageName, String strVoName, boolean pageYn, boolean fileGenYn) {
		(new com.common.tools.BizGenerator()).new VoGen().genVoBySql(strVoPackageName, strVoName, pageYn, fileGenYn);
	}
	 ...
	 * @param fileGenYn (소스를 파일로 생성할지 여부.) 예) com.common.tools.BizGenerator.genSqlForCud("TB_EVT_INFO", "이벤트정보", true, false);
	 */
	public static void genSqlForCud(String TABLE_NAME, String TABLE_HAN_NAME, boolean cudOnlyYn, boolean fileGenYn) {
		(new com.common.tools.BizGenerator()).new SqlGen().genSqlByTable(TABLE_NAME, TABLE_HAN_NAME, COMM_CUD_PACKAGE_NAME, COMM_CUD_DAO_NAME, cudOnlyYn, fileGenYn);
	}
	 ...
	 * @param cudOnlyYn (CUD용인지여부. false일 경우 조회용 쿼리를 생성하지 않음.)
	 * @param fileGenYn (소스를 파일로 생성할지 여부.) 예) com.common.tools.BizGenerator.genSqlByTable("TB_EVT_INFO", "이벤트정보", "com.test.biz.event", "EventDao", false, false);
	 */
	public static void genSqlByTable(String TABLE_NAME, String TABLE_HAN_NAME, String strDaoPackageName, String strDaoName, boolean cudOnlyYn, boolean fileGenYn) {
		(new com.common.tools.BizGenerator()).new SqlGen().genSqlByTable(TABLE_NAME, TABLE_HAN_NAME, strDaoPackageName, strDaoName, cudOnlyYn, fileGenYn);
	}
	 ...
	 * @param fileGenYn (SQL 소스를 파일로 생성할지 여부.) 예) com.common.tools.BizGenerator.genSqlBySql( "com.test.biz.event", "EventDao", "listEvent", "이벤트리스트조회", "com.test.biz.event.vo", "EventListVo", true, false);
	 */
	public static void genSqlBySql(String strDaoPackageName, String strDaoName, String strMethodName, String strMethodComment, String strVoPackageName, String strVoName, boolean pageYn, boolean fileGenYn) {
		(new com.common.tools.BizGenerator()).new SqlGen().genSqlBySql(strDaoPackageName, strDaoName, strMethodName, strMethodComment, strVoPackageName, strVoName, pageYn, fileGenYn);
	}
	 ...
	 * @param fileGenYn (DAO소스를 파일로 생성할지 여부.) 예) com.common.tools.BizGenerator.genDaoForCud("TB_EVT_INFO", "이벤트정보", true, false);
	 */
	public static void genDaoForCud(String TABLE_NAME, String TABLE_HAN_NAME, boolean cudOnlyYn, boolean fileGenYn) {
		(new com.common.tools.BizGenerator()).new DaoGen().genDaoByTable(TABLE_NAME, TABLE_HAN_NAME, COMM_CUD_PACKAGE_NAME, COMM_CUD_DAO_NAME, cudOnlyYn, fileGenYn);
	}
	 ...
	 * @param strDaoName (DAO 명. 필수.)
	 * @param cudOnlyYn (CUD용인지여부. false일 경우 조회용 메소드를 생성하지 않음.)
	 * @param fileGenYn (DAO소스를 파일로 생성할지 여부.) 예) com.common.tools.BizGenerator.genDaoByTable("TB_EVT_INFO", "이벤트정보", "com.test.biz.event", "EventDao", false, false);
	 */
	public static void genDaoByTable(String TABLE_NAME, String TABLE_HAN_NAME, String strDaoPackageName, String strDaoName, boolean cudOnlyYn, boolean fileGenYn) {
		(new com.common.tools.BizGenerator()).new DaoGen().genDaoByTable(TABLE_NAME, TABLE_HAN_NAME, strDaoPackageName, strDaoName, cudOnlyYn, fileGenYn);
	}
	 ...
	 * @param fileGenYn (DAO소스를 파일로 생성할지 여부.) 예) com.common.tools.BizGenerator.genDaoBySql( "com.test.biz.event", "EventDao", "listEvent", "이벤트리스트조회", "com.test.biz.event.vo", "EventListVo", true, false);
	 */
	public static void genDaoBySql(String strDaoPackageName, String strDaoName, String strMethodName, String strMethodComment, String strVoPackageName, String strVoName, boolean listYn, boolean pageYn, boolean fileGenYn) {
		(new com.common.tools.BizGenerator()).new DaoGen().genDaoBySql(strDaoPackageName, strDaoName, strMethodName, strMethodComment, strVoPackageName, strVoName, listYn, pageYn, fileGenYn);
	}
	 ...
	 * @param fileGenYn (SVC소스를 파일로 생성할지 여부.) 예) com.common.tools.BizGenerator.genSvcForJsp( "com.test.biz.event", "EventService", "com.test.biz.event", "EventDao", "listEvent", "이벤트리스트조회", "com.test.biz.event.vo", "EventListVo", 0, true, false);
	 */
	public static void genSvc(String strSvcPackageName, String strSvcName, String strDaoPackageName, String strDaoName, String strMethodName, String strMethodComment, String strVoPackageName, String strVoName, int CRUD, String strTableName, boolean pageYn, boolean fileGenYn) {
		(new com.common.tools.BizGenerator()).new SvcGen().genSvc(strSvcPackageName, strSvcName, strDaoPackageName, strDaoName, strMethodName, strMethodComment, strVoPackageName, strVoName, CRUD, strTableName, pageYn, fileGenYn);
	}
	 ...
	 * @param pageYn (페이징 여부. CRUD가 0 일 경우에만 의미있음.)
	 * @param fileGenYn (CTRL소스를 파일로 생성할지 여부.) 예) com.common.tools.BizGenerator.genCtrlForJsp( "com.test.biz.event", "EventController", "com.test.biz.event", "EventService", "listEvent", "이벤트리스트조회", "com.test.biz.event.vo", "EventListVo", 0, "TB_EVENT", "/jsp/event", "/listEventPlain.do", "listEventPlain", true, false);
	 */
	public static void genCtrlForJsp(String strCtrlPackageName, String strCtrlName, String strSvcPackageName, String strSvcName, String strMethodName, String strMethodComment, String strVoPackageName, String strVoName, int CRUD, String strTableName, String strPrefix, String strUri, String strReturnJsp, boolean pageYn, boolean fileGenYn) {
		(new com.common.tools.BizGenerator()).new CtrlGen().genCtrlForJsp(strCtrlPackageName, strCtrlName, strSvcPackageName, strSvcName, strMethodName, strMethodComment, strVoPackageName, strVoName, CRUD, strTableName, strPrefix, strUri, strReturnJsp, pageYn, fileGenYn);
	}
	 ...
	 * @param strUri (메소드 URI. 메소드의 @RequestMapping(value = "")에 들어갈 값. 필수.)
	 * @param pageYn (페이징 여부. CRUD가 0 일 경우에만 의미있음.)
	 * @param fileGenYn (CTRL소스를 파일로 생성할지 여부.) 예) com.common.tools.BizGenerator.genCtrlForJson( "com.test.biz.event", "EventController", "com.test.biz.event", "EventService", "listEvent", "이벤트리스트조회", "com.test.biz.event.vo", "EventListVo", 0, "TB_EVENT", "/jsp/event", "/listEventPlain.do", false);
	 */
	public static void genCtrlForJson(String strCtrlPackageName, String strCtrlName, String strSvcPackageName, String strSvcName, String strMethodName, String strMethodComment, String strVoPackageName, String strVoName, int CRUD, String strTableName, String strPrefix, String strUri, boolean pageYn, boolean fileGenYn) {
		(new com.common.tools.BizGenerator()).new CtrlGen().genCtrlForJson(strCtrlPackageName, strCtrlName, strSvcPackageName, strSvcName, strMethodName, strMethodComment, strVoPackageName, strVoName, CRUD, strTableName, strPrefix, strUri, pageYn, fileGenYn);
	}
	 ...
	 * @param pageYn (페이징 여부. CRUD가 0 일 경우에만 의미있음.)
	 * @param fileGenYn (WS소스를 파일로 생성할지 여부.) 예) com.common.tools.BizGenerator.genWsForRestFul( "com.test.biz.event.ws", "WsEventService", "com.test.biz.event", "EventService", "/Event", "PUT", "listEvent", "이벤트리스트조회", "com.test.biz.event.vo.ws", "EventListWsVo", "com.test.biz.event.vo", "EventListVo", 0, "TB_EVENT", "XML", true, false);
	 */
	public static void genWsForRestFul(String strWSPackageName, String strWSName, String strSvcPackageName, String strSvcName, String strWSPath, String strMethodKind, String strMethodName, String strMethodComment, String strWsVoPackageName, String strWsVoName, String strVoPackageName, String strVoName, int CRUD, String strTableName, String strMediaType, boolean pageYn, boolean fileGenYn) {
		(new com.common.tools.BizGenerator()).new WsGen().genWsForRestFul(strWSPackageName, strWSName, strSvcPackageName, strSvcName, strWSPath, strMethodKind, strMethodName, strMethodComment, strWsVoPackageName, strWsVoName, strVoPackageName, strVoName, CRUD, strTableName, strMediaType, pageYn, fileGenYn);
	}
	...
	public static void genTestSrcForJsp(int CRUD, String strTableName, String strPrefix, String strUri, String strVoPackageName, String strVoName, boolean pageYn) {
		(new com.common.tools.BizGenerator()).new TestGen().genTestSrcForJsp(CRUD, strTableName, strPrefix, strUri, strVoPackageName, strVoName, pageYn);
	}
	...
	public static void genTestSrcForJson(int CRUD, String strTableName, String strPrefix, String strUri, String strVoPackageName, String strVoName, boolean pageYn) {
		(new com.common.tools.BizGenerator()).new TestGen().genTestSrcForJson(CRUD, strTableName, strPrefix, strUri, strVoPackageName, strVoName, pageYn);
	}
	 ...
	 * @param strVoName (VO 명-파라메터. 필수.)
	 * @param CRUD (트랜젝션종류 - 0:다건조회, 1:단건조회, 2:입력, 3:수정, 4:삭제.)
	 * @param strMediaType (미디어타입:XML/JSON). 필수.) 예) (new com.common.tools.BizGenerator()).new TestGen().genTestSrcForWsJquery("/Event", "PUT", "listEvent", "com.test.biz.event.vo", "EventListWsVo", 0, "XML");
	 */
	public static void genTestSrcForWsJquery(String strWSPath, String strMethodKind, String strMethodName, String strVoPackageName, String strVoName, int CRUD, String strMediaType) {
		(new com.common.tools.BizGenerator()).new TestGen().genTestSrcForWsJquery(strWSPath, strMethodKind, strMethodName, strVoPackageName, strVoName, CRUD, strMediaType);
	}
	 ...
	 * @param strVoName (VO 명-파라메터. 필수.)
	 * @param CRUD (트랜젝션종류 - 0:다건조회, 1:단건조회, 2:입력, 3:수정, 4:삭제.)
	 * @param strMediaType (미디어타입:XML/JSON). 필수.) 예) (new com.common.tools.BizGenerator()).new TestGen().genTestSrcForWsJava("/Event", "PUT", "listEvent", "com.test.biz.event.vo", "EventListWsVo", 0, "XML");
	 */
	public static void genTestSrcForWsJava(String strWSPath, String strMethodKind, String strMethodName, String strVoPackageName, String strVoName, int CRUD, String strMediaType) {
		(new com.common.tools.BizGenerator()).new TestGen().genTestSrcForWsJava(strWSPath, strMethodKind, strMethodName, strVoPackageName, strVoName, CRUD, strMediaType);
	}
		...
		public static TabInfo getTab(String TABLE_NAME){
			...
			try {
				if(tabs.containsKey(TABLE_NAME)){
					...
					// 1. 컬럼기본정보 조회
					ds = com.common.tools.BizGenerator.Util.getCols(TABLE_NAME);
					if(ds != null){
						if (ds.getRowCnt() > 0) {
					...
					// 2. 키값 조회
					ds = com.common.tools.BizGenerator.Util.getKeys(TABLE_NAME);
					if(ds != null){
						if (ds.getRowCnt() > 0) {
							for (int i = 0; i < ds.getRowCnt(); i++) {
	...
	protected class VoGen {
		 ...
		 * @param strVoName (VO명. 옵션(없을경우 테이블명으로 자동생성))
		 * @param fileGenYn (소스를 파일로 생성할지 여부.) 예) (new com.common.tools.BizGenerator()).new VoGen().genVoByTable("TB_EVT_INFO", "이벤트정보", "com.test.biz.event.vo", "EventListVo", true);
		 */
		protected void genVoByTable(String TABLE_NAME, String TABLE_HAN_NAME, String strVoPackageName, String strVoName, boolean fileGenYn) {
			...
			if (TABLE_NAME == null || "".equals(TABLE_NAME)) {
				...
				if (strVoName == null || "".equals(strVoName)) {
					if (TABLE_NAME != null && !"".equals(TABLE_NAME)) {
						strVoName = com.common.utils.StringUtil.getHungarian(TABLE_NAME, " ").trim() + "CudVo";
					}
				}
				if (strVoPackageName == null || "".equals(strVoPackageName)) {
					strVoPackageName = com.common.tools.BizGenerator.COMM_CUD_PACKAGE_NAME + ".vo";
				}
				...
				try {
					...
					vo.append("public class " + strVoName + " extends com.common.biz.BaseVo implements java.io.Serializable { ").append("\n");
					if (cols != null) {
					...
					voStr = vo.toString();
					if (fileGenYn) {
						com.common.utils.FileUtil.writeFile(SRC_ROOT + "/" + StringUtil.replace(strVoPackageName, ".", "/"), strVoName + ".java", voStr, CHARSET);
					}
					System.out.println("============================ VO START ============================");
		...
		/**
		 * <개요> SQL로 VO 생성하는 메소드. com.common.tools.BizGenerator.SQL_LOCATION에 정의된 SQL을 기반으로 VO를 생성한다. SQL로 VO 생성하는 메소드.(파일자동생성)
		 * 
		 * @param strVoPackageName (VO패키지명. 필수.)
		 * @param strVoName (VO명. 필수.)
		 * @param pageYn (페이징용 카운트 멤버를 생성할지 여부. 페이징이 들어가는 화면에 사용되는 VO라면 true로 세팅.)
		 * @param fileGenYn (소스를 파일로 생성할지 여부.) 예) (new com.common.tools.BizGenerator()).new VoGen().genVoBySql("com.test.biz.event.vo", "EventListVo", true);
		 */
		protected void genVoBySql(String strVoPackageName, String strVoName, boolean pageYn, boolean fileGenYn) {
			...
			String sql = com.common.utils.FileUtil.readFile(SQL_LOCATION, CHARSET);
			StringBuffer vo = new StringBuffer();
	...
	protected class SqlGen {
		 ...
		 * @param strDaoName (DAO 명. 필수.)
		 * @param cudOnlyYn (CUD용인지여부. false일 경우 조회용 쿼리를 생성하지 않음.)
		 * @param fileGenYn (SQL 소스를 파일로 생성할지 여부.) 예) (new com.common.tools.BizGenerator()).new SqlGen().genSqlByTable("TB_EVT_INFO", "이벤트정보", "com.test.biz.event", "EventDao", false, false);
		 */
		protected void genSqlByTable(String TABLE_NAME, String TABLE_HAN_NAME, String strDaoPackageName, String strDaoName, boolean cudOnlyYn, boolean fileGenYn) {
			...
			tableName = com.common.utils.StringUtil.getHungarian(TABLE_NAME, " ").trim();
			voName = com.common.utils.StringUtil.getHungarian(TABLE_NAME, " ").trim() + "CudVo";
			sVoName = com.common.utils.StringUtil.getHungarian(TABLE_NAME, "").trim() + "CudVo";
			...
			if (fileExists) {
				xmlFileConts = com.common.utils.FileUtil.readFile(fullFileName, CHARSET);
			...
			if (fileGenYn) {
				com.common.utils.FileUtil.writeFile(FileUtil.getFilePath(fullFileName), FileUtil.getFileName(fullFileName), xmlFileConts, CHARSET);
			}
		 ...
		 * @param strVoName (VO명. 필수.)
		 * @param pageYn (카운트 SQL을 생성할지 여부.)
		 * @param fileGenYn (SQL 소스를 파일로 생성할지 여부.) 예) (new com.common.tools.BizGenerator()).new sqlGen().genSqlBySql("com.test.biz.event", "EventDao", "listEvent", "이벤트리스트", "com.test.biz.event.vo", "EventListVo", true, false);
		 */
		protected void genSqlBySql(String strDaoPackageName, String strDaoName, String strMethodName, String strMethodComment, String strVoPackageName, String strVoName, boolean pageYn, boolean fileGenYn) {
			...
			sql = com.common.utils.FileUtil.readFile(SQL_LOCATION, CHARSET);
	...
	protected class DaoGen {
		 ...
		 * @param strDaoName (DAO 명. 필수.)
		 * @param cudOnlyYn (CUD용인지여부. false일 경우 조회용 메소드를 생성하지 않음.)
		 * @param fileGenYn (DAO소스를 파일로 생성할지 여부.) 예) (new com.common.tools.BizGenerator()).new DaoGen().genDaoByTable("TB_EVT_INFO", "이벤트정보", "com.test.biz.event", "EventDao", false, false);
		 */
		protected void genDaoByTable(String TABLE_NAME, String TABLE_HAN_NAME, String strDaoPackageName, String strDaoName, boolean cudOnlyYn, boolean fileGenYn) {
			...
			if ((PACKAGE_NAME + "." + daoName).equals(COMM_CUD_PACKAGE_NAME + "." + COMM_CUD_DAO_NAME + "")) {
				nameSpace = StringUtil.replace((PACKAGE_NAME + "." + strDaoName).toUpperCase(), ".", "_");
				daoH.append("public class " + daoName + " extends com.common.biz.BaseDao { ").append("\n");
			} else {
				nameSpace = StringUtil.replace((PACKAGE_NAME + "." + strDaoName).toUpperCase(), ".", "_");
				daoH.append("public class " + daoName + " extends com.common.biz.BaseDao { ").append("\n");
			}
			...
			if (!fileGenYn) {
				...
				if (!FileUtil.isFileExist(daoFileName)) {
					com.common.utils.FileUtil.writeFile(FileUtil.getFilePath(daoFileName), FileUtil.getFileName(daoFileName), daoH.toString() + daoF.toString(), CHARSET);
				}
				fileConts = com.common.utils.FileUtil.readFile(daoFileName, CHARSET);
				...
				com.common.utils.FileUtil.writeFile(FileUtil.getFilePath(daoFileName), FileUtil.getFileName(daoFileName), fileConts, CHARSET);
			}
		 ...
		 * @param listYn (리스트성인지 상세조회성인지 여부.)
		 * @param pageYn (카운트 SQL을 생성할지 여부.)
		 * @param fileGenYn (DAO소스를 파일로 생성할지 여부.) 예) (new com.common.tools.BizGenerator()).new DaoGen().genDaoBySql( "com.test.biz.event", "EventDao", "listEvent", "이벤트리스트조회", "com.test.biz.event.vo", "EventListVo", false, true, false);
		 */
		protected void genDaoBySql(String strDaoPackageName, String strDaoName, String strMethodName, String strMethodComment, String strVoPackageName, String strVoName, boolean listYn, boolean pageYn, boolean fileGenYn) {
			...
			if(!isDaoFileNameExists || !com.common.utils.BeanUtil.isBeanMemberName(PACKAGE_NAME + "." + daoName, SQL_CLIENT_ID)){
	...
	protected class SvcGen {
		 ...
		 * @param strTableName (테이블 명-CRUD가 2:입력, 3:수정, 4:삭제 일 경우에만 해당)
		 * @param pageYn (페이징 여부. CRUD가 0 일 경우에만 의미있음.)
		 * @param fileGenYn (SVC소스를 파일로 생성할지 여부.) 예) (new com.common.tools.BizGenerator()).new WsGen().genSvcForJsp( "com.test.biz.event", "EventService", "com.test.biz.event", "EventDao", "listEvent", "이벤트리스트조회", "com.test.biz.event.vo", "EventListVo", 0, true, false);
		 */
		protected void genSvc(String strSvcPackageName, String strSvcName, String strDaoPackageName, String strDaoName, String strMethodName, String strMethodComment, String strVoPackageName, String strVoName, int CRUD, String strTableName, boolean pageYn, boolean fileGenYn) {
			...
			String svcName = "";
			String svcFileName = "";
			String commonDaoAlias = com.common.tools.BizGenerator.COMM_CUD_DAO_NAME.substring(0, 1).toLowerCase() + com.common.tools.BizGenerator.COMM_CUD_DAO_NAME.substring(1);
			...
			if (CRUD == 2 || CRUD == 3 || CRUD == 4) {
				if (!StringUtil.isEmpty(strTableName)) {
					...
					tableVoName = com.common.utils.StringUtil.getHungarian(strTableName, " ").trim() + "CudVo";
					tableName = com.common.utils.StringUtil.getHungarian(strTableName, " ").trim();
				}
				// KEY값 구해오는 부분.
			...
			try {
				...
				svcH.append(" ").append("\n");
				svcH.append("import com.common.biz.BaseService; ").append("\n");
				svcH.append(" ").append("\n");
				...
				if (!FileUtil.isFileExist(svcFileName)) {
					...
					svcConts.append("    private " + com.common.tools.BizGenerator.COMM_CUD_PACKAGE_NAME + "." + com.common.tools.BizGenerator.COMM_CUD_DAO_NAME + " " + commonDaoAlias + "; ").append("\n");
				...
				} else if (!com.common.utils.BeanUtil.isBeanMemberName(PACKAGE_NAME + "." + strSvcName, daoAlias)) {
					if (!com.common.utils.BeanUtil.isBeanMemberName(PACKAGE_NAME + "." + strSvcName, commonDaoAlias)) {
						svcConts.append("    /********* 공통 입력/수정/삭제 DAO 정의부분 시작 *********/").append("\n");
						svcConts.append("    @Autowired ").append("\n");
						svcConts.append("    private " + com.common.tools.BizGenerator.COMM_CUD_PACKAGE_NAME + "." + com.common.tools.BizGenerator.COMM_CUD_DAO_NAME + " " + commonDaoAlias + "; ").append("\n");
						svcConts.append("    /********* 공통 입력/수정/삭제 DAO 정의부분 끝 *********/").append("\n");
					...
					if (CRUD == 0 || CRUD == 1) {
						if (!StringUtil.isEmpty(strDaoPackageName) && !StringUtil.isEmpty(strDaoName)) {
							if (!com.common.utils.BeanUtil.isBeanMemberName(strDaoPackageName + "." + strDaoName, daoAlias)) {
								svcConts.append("    /********* DAO 정의부분 시작 *********/").append("\n");
								svcConts.append("    @Autowired ").append("\n");
								svcConts.append("    private " + strDaoPackageName + "." + strDaoName + " " + daoAlias + "; ").append("\n");
								svcConts.append("    /********* DAO 정의부분 끝 *********/").append("\n");
				...
				if (CRUD == 0) {
					...
					if (pageYn) {
						...
						svcConts.append("        com.common.utils.PageUtil pageUtil; 						// 페이징 유틸 ").append("\n");
					...
					if (pageYn) {
						...
						svcConts.append("            pageUtil = new com.common.utils.PageUtil(paramVo.getPAGE_NUM(), paramVo.getPAGE_SIZE(), INT_TOTAL_CNT);").append("\n");
				...
				if (fileGenYn) {
					if (!FileUtil.isFileExist(svcFileName)) {
						com.common.utils.FileUtil.writeFile(FileUtil.getFilePath(svcFileName), FileUtil.getFileName(svcFileName), svcH.toString() + svcF.toString(), CHARSET);
					}
					fileConts = com.common.utils.FileUtil.readFile(svcFileName, CHARSET);
					String fileContsH = fileConts.substring(0, fileConts.lastIndexOf("}"));
					String fileContsF = fileConts.substring(fileConts.lastIndexOf("}"));
					fileConts = fileContsH + "\n" + svcConts.toString() + "\n" + fileContsF;
					// System.out.println(fileConts);
					com.common.utils.FileUtil.writeFile(FileUtil.getFilePath(svcFileName), FileUtil.getFileName(svcFileName), fileConts, CHARSET);
				}
		...
		private String getPagingLogic(String dbKind){
			...
			if ("ORACLE".equals(dbKind)) {
				...
				paging.append("            if ( 1>paramVo.getPAGE_SIZE() ) { paramVo.setPAGE_SIZE(com.common.utils.PageUtil.DEFAULT_PAGE_SIZE); } ").append("\n");
	...
	protected class CtrlGen {
		 ...
		 * @param strReturnJsp (CTRL 리턴JSP명. ModelAndView.setViewName( strPrefix + "/" + strReturnJsp )로 반환. 필수.)
		 * @param pageYn (페이징 여부. CRUD가 0 일 경우에만 의미있음.)
		 * @param fileGenYn (CTRL소스를 파일로 생성할지 여부.) 예) (new com.common.tools.BizGenerator()).new CtrlGen().genCtrlForJsp( "com.test.biz.event", "EventController", "com.test.biz.event", "EventService", "listEvent", "이벤트리스트조회", "com.test.biz.event.vo", "EventListVo", 0, "TB_EVENT", "/jsp/event", "/listEventPlain.do", "listEventPlain", true, false);
		 */
		protected void genCtrlForJsp(String strCtrlPackageName, String strCtrlName, String strSvcPackageName, String strSvcName, String strMethodName, String strMethodComment, String strVoPackageName, String strVoName, int CRUD, String strTableName, String strPrefix, String strUri, String strReturnJsp, boolean pageYn, boolean fileGenYn) {
			...
			if (CRUD == 2 || CRUD == 3 || CRUD == 4) {
				if (!StringUtil.isEmpty(strTableName)) {
					...
					strVoName = com.common.utils.StringUtil.getHungarian(strTableName, " ").trim() + "CudVo";
				}
			}
			...
			ctrlH.append("").append("\n");
			ctrlH.append("import com.common.utils.DateUtil;").append("\n");
			ctrlH.append("import com.common.utils.PropUtil;").append("\n");
			ctrlH.append("import com.common.utils.StringUtil;").append("\n");
			ctrlH.append("import com.common.utils.BeanUtil;").append("\n");

			ctrlH.append("@Controller").append("\n");
			ctrlH.append("@RequestMapping(value = \"" + strPrefix + "/*\")").append("\n");

			ctrlH.append("public class " + strCtrlName + " extends com.common.biz.BaseController { ").append("\n");
			ctrlH.append("    ").append("\n");
			...
			if (!FileUtil.isFileExist(ctrlFileName)) {
				...
				if (!com.common.utils.BeanUtil.isBeanMemberName(PACKAGE_NAME + "." + strCtrlName, svcAlias)) {
					ctrlConts.append("    /********* SVC 정의부분 시작 *********/").append("\n");
					ctrlConts.append("    @Autowired ").append("\n");
					ctrlConts.append("    private " + strSvcPackageName + "." + strSvcName + " " + svcAlias + "; ").append("\n");
					ctrlConts.append("    /********* SVC 정의부분 끝 *********/").append("\n");
			...
			if (CRUD == 0) {
				...
				ctrlConts.append("   		com.common.utils.RequestUtil 					requestUtil;").append("\n");
				...
				ctrlConts.append("   			requestUtil 			= new com.common.utils.RequestUtil(request, response);").append("\n");
				...
				if (pageYn) {
					...
					ctrlConts.append("   			if(!com.common.utils.StringUtil.isEmpty(requestUtil.getParameter(\"PAGE_NUM\", \"\"))){").append("\n");
					ctrlConts.append("   				paramVo.setPAGE_NUM(requestUtil.getIntParameter(\"PAGE_NUM\"));").append("\n");
					ctrlConts.append("   				paramVo.setPAGE_SIZE(com.common.utils.PageUtil.DEFAULT_PAGE_SIZE);").append("\n");
					ctrlConts.append("   			}").append("\n");
				...
				ctrlConts.append("   			request.setAttribute(\"RETURN_CD\"	, com.common.biz.BaseController.RETURN_SUCCESS );").append("\n");
				...
				ctrlConts.append("   			mav.setViewName(\"" + com.common.tools.BizGenerator.JSP_ROOT_PATH + strPrefix + "/" + strReturnJsp + "\");").append("\n");
			...
			ctrlConts.append("   			request.setAttribute(\"RETURN_CD\"	, com.common.biz.BaseController.RETURN_FAIL );").append("\n");
			...
			if (fileGenYn) {
				if (!FileUtil.isFileExist(ctrlFileName)) {
					com.common.utils.FileUtil.writeFile(FileUtil.getFilePath(ctrlFileName), FileUtil.getFileName(ctrlFileName), ctrlH.toString() + ctrlF.toString(), CHARSET);
				}
				fileConts = com.common.utils.FileUtil.readFile(ctrlFileName, CHARSET);
				String fileContsH = fileConts.substring(0, fileConts.lastIndexOf("}"));
				String fileContsF = fileConts.substring(fileConts.lastIndexOf("}"));
				fileConts = fileContsH + "\n" + ctrlConts.toString() + "\n" + fileContsF;
				// System.out.println(fileConts);
				com.common.utils.FileUtil.writeFile(FileUtil.getFilePath(ctrlFileName), FileUtil.getFileName(ctrlFileName), fileConts, CHARSET);
			}
		 ...
		 * @param strUri (메소드 URI. 메소드의 @RequestMapping(value = "")에 들어갈 값. 필수.)
		 * @param pageYn (페이징 여부. CRUD가 0 일 경우에만 의미있음.)
		 * @param fileGenYn (CTRL소스를 파일로 생성할지 여부.) 예) (new com.common.tools.BizGenerator()).new CtrlGen().genCtrlForJson( "com.test.biz.event", "EventController", "com.test.biz.event", "EventService", "listEvent", "이벤트리스트조회", "com.test.biz.event.vo", "EventListVo", 0, "TB_EVENT", "/jsp/event", "/listEventPlain.do",true , false);
		 */
		protected void genCtrlForJson(String strCtrlPackageName, String strCtrlName, String strSvcPackageName, String strSvcName, String strMethodName, String strMethodComment, String strVoPackageName, String strVoName, int CRUD, String strTableName, String strPrefix, String strUri, boolean pageYn, boolean fileGenYn) {
			...
			if (CRUD == 0) {
				...
				if (pageYn) {
					ctrlConts.append("   			/*** 페이징파라메터 세팅 시작 ***/").append("\n");
					ctrlConts.append("   			if(!com.common.utils.StringUtil.isEmpty(requestUtil.getJsonParameterValue(\"PAGE_NUM\"))){").append("\n");
				...
				ctrlConts.append("   			returnObj 				= " + svcAlias + "." + strMethodName + "(paramVo);").append("\n");
				ctrlConts.append("   			// 3. 결과처리").append("\n");
				ctrlConts.append("   			mav.addObject(\"RETURN_CD\", com.common.biz.BaseController.RETURN_SUCCESS );").append("\n");
				ctrlConts.append("   			mav.addObject(\"returnObj\", returnObj	);").append("\n");
				if (pageYn) {
					ctrlConts.append("   			/*** 페이징객체 세팅 시작 ***/").append("\n");
					ctrlConts.append("   			mav.addObject(\"pageHTML\", ((com.common.utils.PageUtil) returnObj.get(\"pageUtil\")).htmlPostPage(request, \"MAIN_FORM\", \"PAGE_NUM\", \"goPage\")	);").append("\n");
			...
			ctrlConts.append("   		} catch (Exception e) {").append("\n");
			ctrlConts.append("   			handleException(request, response, e);").append("\n");
			ctrlConts.append("   			mav.addObject(\"RETURN_CD\", com.common.biz.BaseController.RETURN_FAIL );").append("\n");
			ctrlConts.append("   		}").append("\n");
			ctrlConts.append("   		return mav;").append("\n");
			ctrlConts.append("    } ").append("\n");
	...
	protected class WsGen {
		 ...
		 * @param strMediaType (미디어타입:XML/JSON). 필수.)
		 * @param pageYn (페이징 여부. CRUD가 0 일 경우에만 의미있음.)
		 * @param fileGenYn (WS소스를 파일로 생성할지 여부.) 예) (new com.common.tools.BizGenerator()).new WsGen().genWsForRestFul( "com.test.biz.event.ws", "WsEventService", "com.test.biz.event", "EventService", "/Event", "PUT", "listEvent", "이벤트리스트조회", "com.test.biz.event.vo", "EventListVo", "com.test.biz.event.ws", "EventListWsVo", 0, "TB_EVENT", "XML", true, false);
		 */
		protected void genWsForRestFul(String strWSPackageName, String strWSName, String strSvcPackageName, String strSvcName, String strWSPath, String strMethodKind, String strMethodName, String strMethodComment, String strWsVoPackageName, String strWsVoName, String strVoPackageName, String strVoName, int CRUD, String strTableName, String strMediaType, boolean pageYn, boolean fileGenYn) {
			...
			try {
				...
				if (!FileUtil.isFileExist(wsFileName)) {
					...
					if (!com.common.utils.BeanUtil.isBeanMemberName(strWSPackageName + "." + strWSName, svcAlias)) {
						svcH.append("    /********* SVC 정의부분 시작 *********/").append("\n");
						svcH.append("    @Autowired ").append("\n");
						svcH.append("    private " + strSvcPackageName + "." + strSvcName + " " + svcAlias + "; ").append("\n");
						svcH.append("    /********* SVC 정의부분 끝 *********/").append("\n");
				...
				if (fileGenYn) {
					if (!FileUtil.isFileExist(wsFileName)) {
						com.common.utils.FileUtil.writeFile(FileUtil.getFilePath(wsFileName), FileUtil.getFileName(wsFileName), svcH.toString() + svcF.toString(), CHARSET);
					}
					fileConts = com.common.utils.FileUtil.readFile(wsFileName, CHARSET);
					String fileContsH = fileConts.substring(0, fileConts.lastIndexOf("}"));
					String fileContsF = fileConts.substring(fileConts.lastIndexOf("}"));
					fileConts = fileContsH + "\n" + svcConts.toString() + "\n" + fileContsF;
					// System.out.println(fileConts);
					com.common.utils.FileUtil.writeFile(FileUtil.getFilePath(wsFileName), FileUtil.getFileName(wsFileName), fileConts, CHARSET);
				}
				System.out.println(fileConts);
			} catch (Exception e) {
				e.printStackTrace();
		...
		private String genWsVo(String strWsVoPackageName, String strWsVoName, String strVoPackageName, String strVoName, String strMethodComment, int CRUD, String strTableName, String strMediaType, boolean fileGenYn) {
			...
			if (!FileUtil.isFileExist(wsVoFileName)) {
				...
				if (!com.common.utils.BeanUtil.isBeanMemberName(strWsVoPackageName + "." + strWsVoName, voAlias)) {
				...
				// 트랜젝션종류 - 2:입력, 3:수정, 4:삭제
				if (CRUD == 2 || CRUD == 3 || CRUD == 4) {
					if (!com.common.utils.BeanUtil.isBeanMemberName(strWsVoPackageName + "." + strWsVoName, "cudFlag")) {
						voConts.append("	private boolean cudFlag;  ").append("\n");
						voConts.append("	public boolean getCudFlag() { ").append("\n");
						voConts.append("		return cudFlag; ").append("\n");
						voConts.append("	} ").append("\n");
			...
			if (fileGenYn) {
				if (!FileUtil.isFileExist(wsVoFileName)) {
					com.common.utils.FileUtil.writeFile(FileUtil.getFilePath(wsVoFileName), FileUtil.getFileName(wsVoFileName), voH.toString() + voF.toString(), CHARSET);
				}
				fileConts = com.common.utils.FileUtil.readFile(wsVoFileName, CHARSET);
				String fileContsH = fileConts.substring(0, fileConts.lastIndexOf("}"));
				String fileContsF = fileConts.substring(fileConts.lastIndexOf("}"));
				fileConts = fileContsH + "\n" + voConts.toString() + "\n" + fileContsF;
				// System.out.println(fileConts);
				com.common.utils.FileUtil.writeFile(FileUtil.getFilePath(wsVoFileName), FileUtil.getFileName(wsVoFileName), fileConts, CHARSET);
			}
	...
	protected class TestGen {
		...
		private void genTestSrcForJsp(int CRUD, String strTableName, String strPrefix, String strUri, String strVoPackageName, String strVoName, boolean pageYn) {
			...
			try {
				...
				if (CRUD == 0) {
					...
					if (pageYn) {
						buff.append("com.common.utils.PageUtil                                      pageUtil;                                        ").append("\n");
					}
					...
					if (pageYn) {
						buff.append("    pageUtil        = (com.common.utils.PageUtil)returnObj.get(\"pageUtil\");                                   ").append("\n");
					}
					buff.append("}                                                                                                             ").append("\n");
					...
					buff.append("			if(RETURN_CD.equals(com.common.biz.BaseController.RETURN_SUCCESS)){                                                                                   ").append("\n");
					buff.append("		%>	                                                                                                     ").append("\n");
		 ...
		 * @param strWsVoName (웹서비스VO 명-파라메터. 필수.)
		 * @param CRUD (트랜젝션종류 - 0:다건조회, 1:단건조회, 2:입력, 3:수정, 4:삭제.)
		 * @param strMediaType (미디어타입:XML/JSON). 필수.) 예) (new com.common.tools.BizGenerator()).new WsGen().genWsTestSrcForJquery("/Event", "PUT", "listEvent", "com.test.biz.event.vo", "EventListWsVo", 0, "XML");
		 */
		private void genTestSrcForWsJquery(String strWSPath, String strMethodKind, String strMethodName, String strWsVoPackageName, String strWsVoName, int CRUD, String strMediaType) {
			...
			if ("XML".equals(strMediaType)) {
				...
				try {
					Object obj = com.common.tools.DataGenerator.genRandomData(strWsVoPackageName + "." + strWsVoName, 1);
					String dataStr = com.common.utils.BeanUtil.toXml(obj);
				...
				try {
					Object obj = com.common.tools.DataGenerator.genRandomData(strWsVoPackageName + "." + strWsVoName, 1);
					String dataStr = com.common.utils.BeanUtil.toJson(obj);
					dataStr = StringUtil.replace(dataStr, "\"", "\\\"");
					dataStr = StringUtil.replace(dataStr, "\n", "");
		 ...
		 * @param strWsVoName (웹서비스VO 명-파라메터. 필수.)
		 * @param CRUD (트랜젝션종류 - 0:다건조회, 1:단건조회, 2:입력, 3:수정, 4:삭제.)
		 * @param strMediaType (미디어타입:XML/JSON). 필수.) 예) (new com.common.tools.BizGenerator()).new WsGen().genWsTestSrcForJava("/Event", "PUT", "listEvent", "com.test.biz.event.vo", "EventListWsVo", 0, "XML");
		 */
		private void genTestSrcForWsJava(String strWSPath, String strMethodKind, String strMethodName, String strWsVoPackageName, String strWsVoName, int CRUD, String strMediaType) {
			...
			tBuff.append("        com.common.utils.WsUtil wsUtil = new com.common.utils.WsUtil(); ").append("\r\n");
			tBuff.append("        ").append("\r\n");
			tBuff.append("        try {").append("\r\n");
			tBuff.append("            wsUtil.bean = new com.common.utils.WsUtil.Bean(); ").append("\r\n");
			...
			if ("XML".equals(strMediaType)) {
				tBuff.append("            wsUtil.bean.body = com.common.utils.BeanUtil.toXml(bean);").append("\n");
				...
				tBuff.append("            bean = (" + strWsVoPackageName + "." + strWsVoName + ")com.common.utils.BeanUtil.fromXml(outStr, " + strWsVoPackageName + "." + strWsVoName + ".class); ").append("\r\n");
			} else if ("JSON".equals(strMediaType)) {
				tBuff.append("            wsUtil.bean.body = com.common.utils.BeanUtil.toJson(bean);").append("\n");
				tBuff.append("            wsUtil.bean.addHeader(\"Content-Type\", \"application/json; charset="+CHARSET+"\"); ").append("\r\n");
				tBuff.append("            String outStr = wsUtil.execute(wsUtil.bean, \""+CHARSET+"\" ); ").append("\r\n");
				tBuff.append("            bean = (" + strWsVoPackageName + "." + strWsVoName + ")com.common.utils.BeanUtil.fromJson(outStr, " + strWsVoPackageName + "." + strWsVoName + ".class); ").append("\r\n");
			}
	...
	public static class Util {
		/**
		 * Ajax 파일업로드 시 사용하는 JS소스(ajaxfileupload.js) 생성하는 메소드. 예) com.common.tools.BizGenerator.Util.genAjaxFileUploadJs();
		 */
		public static void genAjaxFileUploadJs() {
			...
			ctrlBuff.append("   		com.common.utils.RequestUtil 					requestUtil; ").append("\n");
			ctrlBuff.append("   		/************************ 변수 선언 끝 **************************/ ").append("\n");
			ctrlBuff.append("   		try { ").append("\n");
			ctrlBuff.append("   			/************************ 변수 정의 시작 ************************/ ").append("\n");
			ctrlBuff.append("   			requestUtil 			= new com.common.utils.RequestUtil(request, response); ").append("\n");
		...
		public static com.common.utils.DataSet getCols(String TABLE_NAME) {
			com.common.utils.DbUtil db = null;
			com.common.utils.DataSet ds = null;
		...
		public static com.common.utils.DataSet getKeys(String TABLE_NAME) {
			com.common.utils.DbUtil db = null;
			com.common.utils.DataSet ds = null;
			StringBuffer keySql = new StringBuffer();
