...
public class StringUtil {
	...
	public static String beforeWord(String inputStr, String startStr, String[] div){
		...
		for(int i=0; i<div.length; i++){
			revDiv[i] = com.common.utils.StringUtil.reverse(div[i]);
		}
		beforeStr = nextWord(com.common.utils.StringUtil.reverse(inputStr), com.common.utils.StringUtil.reverse(startStr), div);
		return com.common.utils.StringUtil.reverse(beforeStr);
	}
