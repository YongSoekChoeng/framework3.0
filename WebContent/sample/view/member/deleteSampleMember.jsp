...
<!--폼 시작-->                                                                                                    
<form name="MAIN_FORM" method="post" action="/member/deleteSampleMember.do">                      		 
	<input type='button' name='' value='DELETE' onclick='javascript:goForIt();' >                                 
	<table border=1>    		
		<tr>                                                                                                  
			<td bgcolor=blue >GROUP_ID&nbsp;</td><td><input type='text' name='GROUP_ID' value=''></td>    
		</tr>                                                                                                 
		<tr>                                                                                                  
			<td bgcolor=blue >USER_ID&nbsp;</td><td><input type='text' name='USER_ID' value=''></td>    
		</tr>                                                                                             
	</table>                                                                                                      
