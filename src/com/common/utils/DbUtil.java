...
public class DbUtil {
	...
	public int currentWasKind = com.common.utils.SystemUtil.getInstance().getIntProperty("CURRENT_WAS_KIND");
	...
	public boolean boolViewConvert = com.common.utils.SystemUtil.getInstance().getBoolProperty("DBHANDLER_DATA_ENCODE_CONVERT_YN");
	...
	public DbUtil(String gubun) {
		com.common.utils.SystemUtil info = com.common.utils.SystemUtil.getInstance();
	...
	public boolean getConnection() throws SQLException, Exception {
		...
		if (this.sDataSource.trim().equals("")) {
			try {
				...
				//getDataBaseInfo(con, com.common.utils.SystemUtil.getInstance().getIntProperty("DEBUGGER_DEBUG"));
			...
			if (ds == null) {
				...
				try {
					if (com.common.utils.SystemUtil.getInstance().getProperty("CURRENT_WAS_KIND").trim().equals(com.common.utils.SystemUtil.getInstance().getProperty("WEBSPHERE").trim())) {
						props.put(Context.PROVIDER_URL, com.common.utils.SystemUtil.getInstance().getProperty("CURRENT_PROVIDER_URL"));
						props.put(Context.INITIAL_CONTEXT_FACTORY, com.common.utils.SystemUtil.getInstance().getProperty("CURRENT_INITIAL_CONTEXT_FACTORY"));
						ctx = new InitialContext(props);
					} else if (com.common.utils.SystemUtil.getInstance().getProperty("CURRENT_WAS_KIND").trim().equals(com.common.utils.SystemUtil.getInstance().getProperty("WEBLOGIC").trim())) {
						props.put(Context.PROVIDER_URL, com.common.utils.SystemUtil.getInstance().getProperty("CURRENT_PROVIDER_URL"));
						props.put(Context.INITIAL_CONTEXT_FACTORY, com.common.utils.SystemUtil.getInstance().getProperty("CURRENT_INITIAL_CONTEXT_FACTORY"));
						ctx = new InitialContext(props);
					} else {
					...
					strErrMsg = "PROVIDER_URL[" + com.common.utils.SystemUtil.getInstance().getProperty("CURRENT_PROVIDER_URL") + "] \n";
					strErrMsg = "INITIAL_CONTEXT_FACTORY[" + com.common.utils.SystemUtil.getInstance().getProperty("CURRENT_INITIAL_CONTEXT_FACTORY") + "] \n";
	...
	public void getDataBaseInfo(Connection conn, int debugLevel) {
		if (com.common.utils.SystemUtil.getInstance().getBoolProperty("DBHANDLER_GET_DBINFO_YN")) {
			try {
